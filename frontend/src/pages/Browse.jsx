...
const LOCAL_VIDEOS = [
    { id: 'local_1', title: 'T-Shirt Collection', videoSrc: '/t_shirt.mp4', thumbnail: null },
    { id: 'local_2', title: 'Woman Fashion', videoSrc: '/woman_fashion.mp4', thumbnail: null },
    { id: 'local_3', title: 'Saree Lookbook', videoSrc: '/saree.mp4', thumbnail: null },
    { id: 'local_4', title: 'Earring Styles', videoSrc: '/earring.mp4', thumbnail: null },
    { id: 'local_5', title: 'Shoe Collection', videoSrc: '/shoe1.mp4', thumbnail: null },
    { id: 'local_6', title: 'Cap Styles', videoSrc: '/cap.mp4', thumbnail: null },
    { id: 'local_7', title: 'Churidhar Collection', videoSrc: '/churidhar.mp4', thumbnail: null },
    { id: 'local_8', title: 'Dhoti Fashion', videoSrc: '/dhoti.mp4', thumbnail: null },
    { id: 'local_9', title: 'Belt Styles', videoSrc: '/belt2.mp4', thumbnail: null },
    { id: 'local_10', title: 'Hair Accessories', videoSrc: '/hairclip.mp4', thumbnail: null },
    { id: 'local_11', title: 'Necklace Styles', videoSrc: '/earring_necklace.mp4', thumbnail: null },
    { id: 'local_12', title: 'Girl Fashion 1', videoSrc: '/girl2.mp4', thumbnail: null },
    { id: 'local_13', title: 'Girl Fashion 2', videoSrc: '/girl3.mp4', thumbnail: null },
    { id: 'local_14', title: 'Vedhalam', videoSrc: '/sample1.mp4', thumbnail: null },
    { id: 'local_15', title: 'Sample Video 2', videoSrc: '/sample3.mp4', thumbnail: null },
];
...
const Browse = () => {
    ...
    const [localVideos] = useState(LOCAL_VIDEOS);  // Local videos from public folder
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={{ ...styles.contentSection, marginTop: '-80px', position: 'relative', zIndex: 10 }}>
                {/* LOCAL LIBRARY - Videos from public folder */}
                {localVideos.length > 0 && (
                    <>
                        <div style={styles.rowHeader}>
                            <h3 style={{ ...styles.rowTitle, color: '#00a8e1' }}>📁 Local Library</h3>
                            <span style={styles.seeMore}>Fashion Videos ►</span>
                        </div>
                        <div style={styles.row}>
                            {localVideos.map(video => (
                                <MovieCard key={video.id} movie={video} onClick={handlePlay} />
                            ))}
                        </div>
                    </>
                )}
